...
def rf_channel_importance_heatmap(pos_samples, neg_samples):
    ...
    # # feature_names = ["δ E", "δ E-ratio", "θ E", "θ E-ratio", "α E", "α E-ratio",
    # #                 "β E", "β E-ratio", "γ1 E", "γ1 E-ratio", "γ2 E", "γ2 E-ratio",
    # #                 "γ3 E", "γ3 E-ratio", "γ4 E", "γ4 E-ratio"]
    # feature_names = ["δ E", "δ E-ratio", "θ E", "θ E-ratio", "α E", "α E-ratio",
    #                  "β E", "β E-ratio", "γ1 E", "γ1 E-ratio", "γ2 E", "γ2 E-ratio",
    #                  "γ3 E", "γ3 E-ratio", "γ4 E", "γ4 E-ratio",
    #                  "IMF1 SODP", "IMF1 Vc", "IMF1 Fi", "IMF2 SODP", "IMF2 Vc", "IMF2 Fi"]
    # sns.heatmap(channel_importances, cmap="YlGnBu",
    #             xticklabels=feature_names,
    #             # xticklabels=[f"Feature {i+1}" for i in range(num_features)],
    #             yticklabels=[f"Channel {i + 1}" for i in range(num_channels)])
    # # plt.xticks(fontsize=8)
    # plt.title("Feature Importance Heatmap by Channel")
    # plt.xlabel("Features")
    # plt.ylabel("Channels")
    # plt.show()
...
try:
    ...
    for test_folder in test_folders:
        ...
        for channels_numbers in channels_numbers_list:
            ...
            # positive_data_feature_temp = feature_importance(positive_features, feature_importance)
            # negative_data_feature_temp = feature_importance(negative_features, feature_importance)
